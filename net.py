...
class MAMLmodel(Model):
    def __init__(self, num_classes):
        ...
        self.MaxPool_2 = layers.MaxPool2D(pool_size=2)

        self.Conv2D_5 = layers.Conv2D(filters=64, kernel_size=3, padding="same", activation="relu")
        self.Conv2D_6 = layers.Conv2D(filters=64, kernel_size=3, padding="same", activation="relu")
        self.MaxPool_3 = layers.MaxPool2D(pool_size=2)
